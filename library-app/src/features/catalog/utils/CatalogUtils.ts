...
export function generateRandomGenres():string[] {
    let choices = ['Non-Fiction', 'Childrens', 'Fiction', 'Biography', 'Romance', 'Science Fiction', 'Young Adult'];
...
export function generateRandomBooksByGenres(genre:string, books:Book[]):Book[]{
